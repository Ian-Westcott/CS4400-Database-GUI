...
# Form implementation generated from reading ui file 'pilotview.ui'
#
...
class PilotView(object):
    ...
    def setupUi(self, Form):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(20, 110, 621, 341))
        ...
        self.tableButton.setGeometry(QtCore.QRect(250, 480, 151, 91))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Pilot View</span></p></body></html>"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Username"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "License ID"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Experience"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Form", "# of Drones Piloted"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Form", "# of Drone Locations"))
