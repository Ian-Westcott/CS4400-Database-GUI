...
class UserView(object):
    def ShowTable(self):
            ...
            mycursor = cnx.cursor()
            mycursor.execute("SELECT * FROM restaurant_supply_express.users;")
    ...
    def setupUi(self, Form):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(20, 110, 581, 531))
        ...
        self.tableButton.setGeometry(QtCore.QRect(210, 660, 151, 91))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">User View</span></p></body></html>"))
        ...
        item.setText(_translate("Form", "Birthdate"))
