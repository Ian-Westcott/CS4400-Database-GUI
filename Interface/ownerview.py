...
# Form implementation generated from reading ui file 'ownerview.ui'
#
...
class OwnerView(object):
    ...
    def setupUi(self, Form):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(20, 110, 941, 341))
        ...
        self.tableButton.setGeometry(QtCore.QRect(430, 480, 151, 91))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Owner View</span></p></body></html>"))
        ...
        item.setText(_translate("Form", "# of Locations"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Form", "Max Rating"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("Form", "Min Rating"))
