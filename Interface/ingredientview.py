...
# Form implementation generated from reading ui file 'ingredientview.ui'
#
...
class IngredientView(object):
    def ShowTable(self):
        cnx = mysql.connector.connect(user='root', password='(placeholder)',
                              host='127.0.0.1',
                              database='restaurant_supply_express', port=3306)
        mycursor = cnx.cursor()
        mycursor.execute("SELECT * FROM restaurant_supply_express.display_ingredient_view;")
    ...
    def setupUi(self, Form):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(20, 110, 561, 341))
        ...
        self.tableButton.setGeometry(QtCore.QRect(220, 480, 151, 91))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Ingredient View</span></p></body></html>"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Ingredient Name"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Location"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Quantity"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Form", "Minimum Price"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Form", "Maximum Price"))
