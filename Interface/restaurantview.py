...
# Form implementation generated from reading ui file 'restaurantview.ui'
#
...
class RestaurantView(object):
    def ShowTable(self):
            ...
            mycursor = cnx.cursor()
            mycursor.execute("SELECT * FROM restaurant_supply_express.restaurants;")
    ...
    def setupUi(self, Form):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(20, 110, 511, 441))
        ...
        self.tableButton.setGeometry(QtCore.QRect(200, 570, 151, 91))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Restaurant View"))
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:24pt;\">Restaurant View</span></p></body></html>"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Name"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Rating"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Money Spent"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("Form", "Location"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("Form", "Funded By"))
