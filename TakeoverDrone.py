...
class Takeover_Drone(object):
    ...
    def setupPilots(self):
        cnx = mysql.connector.connect(user='root', password='Fl1ght413612!',
                              ...
                              database='restaurant_supply_express', port=3306)
        mycursor = cnx.cursor()
        mycursor.execute("select username from work_for where (username in (select username from pilots where username not in (select flown_by from drones where id = \'" + self.DroneID.currentText() + "\' and tag = \'" + self.DroneTag.currentText() +"\') or (select flown_by from drones where id = \'" + self.DroneID.currentText() + "\' and tag = \'" + self.DroneTag.currentText() +"\') is null) and id = \'" + self.DroneID.currentText() + "\');")
        myresult = mycursor.fetchall()
        for row_data in myresult:
            for data in row_data:
    ...
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QtCore.QRect(160, -40, 241, 131))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.label_6 = QtWidgets.QLabel(Form)
        self.label_6.setGeometry(QtCore.QRect(20, 180, 61, 31))
        self.label_6.setObjectName("label_6")
        self.takeoverDroneButton = QtWidgets.QPushButton(Form)
        self.takeoverDroneButton.setGeometry(QtCore.QRect(220, 260, 121, 28))
        self.takeoverDroneButton.setObjectName("takeoverDroneButton")
        self.PilotUsername = QtWidgets.QComboBox(Form)
        self.PilotUsername.setGeometry(QtCore.QRect(90, 190, 401, 22))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Change Drone Pilot"))
        self.label_6.setText(_translate("Form", "Pilot \n"
"Username"))
        self.takeoverDroneButton.setText(_translate("Form", "Change Drone Pilot"))
    ...
    def takeoverDrone(self):
        cnx = mysql.connector.connect(user='root', password='Fl1ght413612!',
                          ...
                          database='restaurant_supply_express', port=3306)
        cursor = cnx.cursor()
        cursor.callproc('takeover_drone', [self.PilotUsername.currentText(), self.DroneID.currentText(), self.DroneTag.currentText()])
        cnx.commit()
        cnx.close()
        self.DroneTagChange()
